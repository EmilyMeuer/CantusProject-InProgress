...
class Input
{
  /*
   ...
   Wrapper class to make the loudest frequency of an AudioPlayer easily accessible;
   works best with a monophonic track.
   
   Flickers seem to be it picking up overtones.
   */
...
//  AudioInput input;
  ...
  { 
   ...
   for(int i = 0; i < this.fft.avgSize(); i++)
    ...
    println("this.amplitude = " + this.amplitude);
    } // setFreq
