...
Things to fix: lost balls do to step that is not a factor of the width of the screen (I think)
*/
...
void setup(){
  ...
  in = minim.getLineIn();
  //number of balls for equal spacing
  balls = 20;
  //how sensitive y is to input amp
  amplify = 5000;
  //delayed start for each ball
  x1 = width;
  ...
  y1 = y2 = y3 = y4 = y5 = y6 = y7 = y8 = y9 = y10 = height/2;
  y11 = y12 = y13 = y14 = y15 = y16 = y17 = y18 = y19 = y20 = height/2;
}

void draw(){
  background(0);
  step = in.mix.level()*200;
  //step (speed) is controlled by amplitude too
  ball1();
  ball2();
  ball3();
  ball4();
...
//when ball reaches end of screen, it goes back to "start" and receives a new y=amp
void ball1(){
  fill(200,100,200);
  ellipse(x1,y1,10,10); 
  x1=x1-step;
