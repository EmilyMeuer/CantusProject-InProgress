 ...
 *
 * Michaela Andrews also wrote
 * colorful balls which glide across the screen
 * like a soundwave
 */
...
//matching colors to inputs, getting pitches
  ...
  int pitchb1 = round(redPitch/b1PitAdjust);    //division for creating color gradient for stacks
  int volb1 = round(redVol);                    //turning volume into an integer for fractions
