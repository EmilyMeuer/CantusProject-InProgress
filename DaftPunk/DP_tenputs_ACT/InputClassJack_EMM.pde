...
//    g.addInput(uGenArray[1]);
 ...
 //     println("setFund(); this.frequencyArray[i] = " + this.frequencyArray[i].getFeatures());
      ...
      if (this.frequencyArray[i].getFeatures() != null && this.fundamentalArray != null) {
 //       println("i = " + i);
 //       println("setFund(); this.fundamentalArray[i] = " + this.fundamentalArray[i] + "this.frequencyArray[i] = " + this.frequencyArray[i]);
