...
//ARRAY OBJECTS STEP 4 (for loop)
  ...
  /* rf = red and fuchsia (but now red and fpink)
   * op = orange and purple (orange and pfuchsia)
   * yi = yellow and indigo (yellow ipurple)
   * gp = green and periwinkle (glight green and periwinkle)
   */
  ...
  for(j=0; j<volb1; j++)
  {
    fill(224-5*oldb1, 36-5*oldb1, 71-5*oldb1); //224 36 71 (255 0 0)
  ...
  */
  ...
  for(j=0; j<volb2; j++)
  {
    fill(255-5*oldb2, 90-5*oldb2, 8); //255 90 8 (255 145 0)
  ...
  for(j=0; j<volt1; j++)
  {
    fill(255-5*oldt1, 234-5*oldt1, 44-5*oldt1); //255 234 44 good how it is probably
  ...
  for(j=0; j<volt2; j++)
  {
    fill(162-5*oldt2, 211-5*oldt2, 2); //162 211 2 (41 255 0)
  ...
  for(j=0; j<volt2; j++)
  {
    fill(1, 100-5*oldt2, 65-5*oldt2); //1 100 65 (0 255 232 was CYAN)
  ...
  for(j=0; j<volt2; j++)
  {
    fill(149-5*oldt2, 176-5*oldt2, 250-5*oldt2); //149 176 250 (0 129 255)
  ...
  for(j=0; j<volt1; j++)
  {
    fill(122-5*oldt1, 73-5*oldt1, 155-5*oldt1); //122 73 155 (45 0 255 was indigo)
  ...
  for(j=0; j<volb2; j++)
  {
    fill(247-5*oldb2, 3, 222-5*oldb2); //247 3 222 (139 0 255 was purple)
  ...
  for(j=0; j<volb1; j++)
  {
    fill(255-5*oldb1, 175-5*oldb1, 210-5*oldb1); //255 130 180 (255 0 222 was fuchsia)
