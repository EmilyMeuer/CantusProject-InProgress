...
void setup()
{
  ...
  testInput  = new Input("Horn-54321.wav");
}
...
class Input
{
  /*
   ...
   Class to detect the pitch of an AudioPlayer;
   works best with a monophonic track.
   */
 ...
 //   println("findFund = " + findFund);
    ...
    if (this.fundamental == null) {  
      this.prevFund = Frequency.ofHertz((float)findFund);
    } else {  
